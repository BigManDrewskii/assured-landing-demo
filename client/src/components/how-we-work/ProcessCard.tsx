...
export function ProcessCard({ icon, title, description }: ProcessCardProps) {
  ...
  return (
    <div className="p-8 bg-primary text-primary-foreground group hover:shadow-lg transition-all duration-200 hover:-translate-y-1">
      {/* Icon */}
      <div className="mb-6">
        <Icon className="w-12 h-12 opacity-90 group-hover:opacity-100 transition-opacity" />
      </div>

...
export function HeroSection({
  ...
  return (
    <Section number="01" className="overflow-hidden bg-background">
      <div
        className="mx-auto px-8 pt-32 pb-24 md:pt-40 md:pb-32 relative overflow-hidden"
        style={{ maxWidth: `${maxWidth}px` }}
      >
        {/* Background Animation - contained within hero */}
        {animationPath && (
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-2xl md:text-3xl text-foreground/95 mb-12 max-w-3xl mx-auto font-normal leading-relaxed">
            {subheadline}
          </p>
